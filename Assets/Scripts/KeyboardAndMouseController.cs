...
public class KeyboardAndMouseController : MonoBehaviour
{
    ...
    [SerializeField] private float _gamepadLookInputSmoothTime = 0.08f;
    ...
    private Vector2 _smoothedGamepadLook;
    private Vector2 _gamepadLookVelocity;
    ...
    private void HandleLook()
    {
        ...
        Vector2 rawGamepadLook = _playerActions.Player.GamepadLook.ReadValue<Vector2>();

        _smoothedGamepadLook = Vector2.SmoothDamp(
            _smoothedGamepadLook,
            rawGamepadLook,
            ref _gamepadLookVelocity,
            _gamepadLookInputSmoothTime
        );
